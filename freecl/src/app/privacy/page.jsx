...
export default function PrivacyPage() {
  return (
    ...
    <div className="w-full bg-slate-950 text-white selection:bg-blue-500 selection:text-white relative overflow-hidden flex flex-col justify-start items-center pt-10 pb-8">
      ...
      <div className="max-w-5xl mx-auto px-6 w-full relative z-10">
        ...
        <div className="text-center mb-8 space-y-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold">
            Política de <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">Privacidad</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          {/* Tarjeta 1 */}
          <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-2xl hover:border-blue-500/50 transition-colors group backdrop-blur-sm">
            ...
            <h3 className="text-xl font-bold text-white mb-3">1. Uso de Datos</h3>
          ...
          {/* Tarjeta 2 */}
          <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-2xl hover:border-purple-500/50 transition-colors group backdrop-blur-sm">
            ...
            <h3 className="text-xl font-bold text-white mb-3">2. Almacenamiento Local</h3>
            <p className="text-slate-400 leading-relaxed">
          ...
          {/* Tarjeta 3 */}
          <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-2xl hover:border-green-500/50 transition-colors group backdrop-blur-sm">
            <div className="w-12 h-12 bg-green-500/20 rounded-lg flex items-center justify-center text-green-400 mb-6 group-hover:scale-110 transition-transform">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg>
            </div>
            <h3 className="text-xl font-bold text-white mb-3">3. Código Abierto</h3>
            <p className="text-slate-400 leading-relaxed">
          ...
          {/* Tarjeta 4 */}
          <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-2xl hover:border-yellow-500/50 transition-colors group backdrop-blur-sm">
            <div className="w-12 h-12 bg-yellow-500/20 rounded-lg flex items-center justify-center text-yellow-400 mb-6 group-hover:scale-110 transition-transform">
