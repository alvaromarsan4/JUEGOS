export default function Privacy() {
  return (
    <div className="max-w-3xl mx-auto p-8 animate-fade-in">
      <h2 className="text-3xl font-bold mb-8 border-b border-border pb-4 text-foreground">Política de Privacidad</h2>

      <div className="space-y-6 text-muted-foreground">
        <section>
          <h3 className="text-xl font-semibold text-foreground mb-2">1. Uso de Datos</h3>
          <p>
        ...
        <section>
          <h3 className="text-xl font-semibold text-foreground mb-2">2. Cookies</h3>
          <p>
        ...
        <section>
          <h3 className="text-xl font-semibold text-foreground mb-2">3. Contacto</h3>
          <p>
