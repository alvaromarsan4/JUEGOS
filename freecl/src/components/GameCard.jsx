...
export default function GameCard({ game }) {
  ...
  return (
    <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg relative group transition-transform hover:scale-105">
      ...
      <div className="relative h-48 w-full">
        ...
        {user && (
            <button
              onClick={onToggle}
              disabled={busy}
              className="absolute top-2 right-2 p-2 bg-black/60 rounded-full hover:bg-black/80 transition z-10"
